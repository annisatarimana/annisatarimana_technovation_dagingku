...
<?php $__env->startSection('content'); ?>
    ...
    <div class = "products">
        <div class = "container">
            <h1 class = "lg-title"><i>Category: <span style="color: #ff4321;"><?php echo e($category->cat_name); ?></span></i></h1>
                        <p class = "text-dark"><?php echo e($category->description); ?></p>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\laravel_website_cake_shop_project\resources\views/category/categoryshowuser.blade.php ENDPATH**/ ?>