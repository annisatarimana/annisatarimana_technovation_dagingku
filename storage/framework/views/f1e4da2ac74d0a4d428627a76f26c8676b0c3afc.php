        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('products.update', $product->id)); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input name="title" type="text" class="form-control" id="title"  placeholder="Enter product name" value="<?php echo e($product->title); ?>">
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" name="category_id">
                        <option value="<?php echo e($product->category->id); ?>"><?php echo e($product->category->cat_name); ?></option>
                ...
                <div class="form-group">
                    ...
                    <input name="price" type="number" class="form-control" id="price"  placeholder="Enter product price" value="<?php echo e($product->price); ?>">
                </div>
                <div class="form-group">
                    <label for="sale_price">Product Sale Price</label>
                    <input name="sale_price" type="number" class="form-control" id="sale_price"  placeholder="Enter product sale price" value="<?php echo e($product->sale_price); ?>">
                </div>
                <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label for="image_prods">Product Side Images (multiple files allowed)</label>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\laravel_website_cake_shop_project\resources\views/product/productedit.blade.php ENDPATH**/ ?>