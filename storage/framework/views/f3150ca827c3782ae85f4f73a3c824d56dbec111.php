...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="info">
            <div class="row">
                <div class="col-7">
                    ...
                    <span id="details"><?php echo e(now('Asia/Dhaka')); ?></span>
                </div>
                <div class="col-5 pull-right">
                    <span id="heading">Order No.</span><br>
                    <span id="details"><?php echo e($order->id); ?></span>
                </div>
            </div>
        </div>
        <div class="pricing">
            ...
            <div class="row">
                <div class="col-9">
                    <span id="name"><?php echo e($product['title']); ?></span>
                    <br>
                    <span id="name">Quantity: <?php echo e($product['quantity']); ?></span>
                </div>
                <div class="col-3">
                    <span id="price">BDT <?php echo e($product['product_total']); ?></span>
                </div>
            </div>
        ...
        <div class="total">
            <div class="row">
                <div class="col-9"></div>
                <div class="col-3"><big>BDT <?php echo e($cart['total']+150); ?></big></div>
            </div>
        </div>
        <div class="tracking">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\laravel_website_cake_shop_project\resources\views/cart/orderdetails.blade.php ENDPATH**/ ?>